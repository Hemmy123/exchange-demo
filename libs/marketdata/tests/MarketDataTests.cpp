...
TEST(MarketDataPublisher, TradeNormalizedToMdTrade) {
  ...
  EXPECT_EQ(md.timeStamp, trade.timeStamp); // carried through, NOT re-stamped
...
TEST(MarketDataPublisher, EachPublisherHasIndependentSequence) {
  ...
  a.Publish(
      TradeEvent{.tradeId = 1,
                 ...
                 .aggressorSide = Side::Bid,
                 .restingRemaining = 0,
                 .timeStamp = std::chrono::system_clock::now()}); // a -> seq 1
  a.Publish(
      TradeEvent{.tradeId = 2,
                 ...
                 .aggressorSide = Side::Bid,
                 .restingRemaining = 0,
                 .timeStamp = std::chrono::system_clock::now()}); // a -> seq 2
  b.Publish(
      TradeEvent{.tradeId = 3,
                 ...
                 .aggressorSide = Side::Bid,
                 .restingRemaining = 0,
                 .timeStamp = std::chrono::system_clock::now()}); // b -> seq 1
